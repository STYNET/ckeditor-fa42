 ...
 *   FontAwesome
 *   =========
 *   https://fortytwo-it.com/font-awesome-plugin-for-ckeditor-v4/
 *
 *   Copyright (C) 2023 by fortyTwo IT
 *   Licence under GNU GPL v3.
 * 
 *   Contribute language translation : Stéphan GAYET (sgayet@stynet.com)
 */
CKEDITOR.plugins.add('fa42', {
        requires: 'colordialog',
        version: '0.0.1',
        icons: 'fa42',
        lang: [CKEDITOR.config.language || 'en'],
        onLoad: function() {
        ...
        init: function (editor) {
            // Check and init language
            var lang = editor.config.language || 'en'; // Utilise 'en' par défaut si aucune langue n'est définie
            var langPath = CKEDITOR.getUrl(this.path + 'lang/' + lang + '.js');
            CKEDITOR.scriptLoader.load(this.path + 'lang/' + editor.langCode + '.js');
            ...
            editor.ui.addButton( 'fa42', {
                    label: editor.lang.fa42.insertFontAwesome,
                    command: 'fa42',
                    toolbar: 'insert',
            });
